odoo.define('ng_approvals.InventoryApprovalController', function (require) {
"use strict";
...
var InventoryApprovalController = ListController.extend({
    events: _.extend({
        'click .o_button_approval_inventory': '_onApproveInventory'
        ...
        prom.then(function () {
            self._rpc({
                ...
                var exitCallback = function (infos) {
                    ...
                    self.do_notify(
                        _t("Success"),
                        _t("The inventory has been approved"));
...
return InventoryApprovalController;
