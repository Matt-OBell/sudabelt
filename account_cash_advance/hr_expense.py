...
class hr_expense_line_ret_pay(models.Model):  # sat
    ...
    org_amount = fields.Float(string='Advance Amount', digits_compute=dp.get_precision('Account'), readonly=True)
    open_amount = fields.Float(string='Open Balance', digits_compute=dp.get_precision('Account'), readonly=True)
