...
class company(models.Model):
    ...
    company_notice_period = fields.Float(string='Notice Period by Employer', help='In Months')
    no_payroll_run = fields.Integer(string='Total Number of Payroll', default=1, help='Please specify total number of payroll company can run in month for single employee or batch of employee')
