...
class report_hr_salary_employee_year(models.AbstractModel):
    _name = "report.ng_hr_payroll.yearly_salary_ng_report"
...
#       Get name of the months from integer
    ...
    def cal_monthly_amt(self, form, emp_id):
        ...
        res = []
        salaries = {}
        self._cr.execute('''SELECT rc.code, pl.name, sum(pl.total), \
        ...
        categories = category_ids.read(['code'])
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('ng_hr_payroll.yearly_salary_ng_report', values=docargs)
