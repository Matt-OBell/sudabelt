...
{
    'name': 'Nigerian Payroll for TopLine',
    ...
    * Management of Increments, Overtimes, Notices, Terminal Benefits, Unions, Contract History, etc..
    ...
    'data': [
        ...
        'company_view.xml',
        'ng_hr_view.xml',
        'ng_hr_salary_view.xml',
        'ng_hr_overtime_view.xml',
        'ng_hr_payroll_view.xml',
        'ng_hr_union_view.xml',
        'ng_hr_terminal_view.xml',
        'ng_hr_payroll_workflow.xml',
        'ng_hr_payroll_sequence.xml',
        'ng_hr_payroll_report.xml',
